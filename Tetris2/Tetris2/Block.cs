...
namespace Tetris2.Content
{
    class Block
    {
        ...
        public void BlockUpdate()
        {
            ...
            if (falling)
            {
                if ((Game1.TetrisTable[posX, posY + 3] == 1 && table[0, 2] == 1) || (Game1.TetrisTable[posX + 1, posY + 3] == 1 && table[1, 2] == 1) || (Game1.TetrisTable[posX + 2, posY + 3] == 1 && table[2, 2] == 1))
                {
                    falling = false;
                    for (int i = 0; i < 3; i++)
                        for (int x = 0; x < 3; x++)
                ...
                if ((Game1.TetrisTable[posX, posY + 2] == 1 && table[0, 1] == 1) || (Game1.TetrisTable[posX + 1, posY + 2] == 1 && table[1, 1] == 1) || (Game1.TetrisTable[posX + 2, posY + 2] == 1 && table[2, 1] == 1))
                {
                    falling = false;
                    for (int i = 0; i < 3; i++)
                        for (int x = 0; x < 3; x++)
